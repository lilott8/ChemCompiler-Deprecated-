...
public class VariableNode implements Serializable, Node {
    ...
    public void setOperationID(int id) {
        createdInOperation = id;
    }

    public Boolean isRootDeclaration() {
        return declarationType == VariableType.ROOT_DECLARATION;
    }

    public Boolean isInstructionDeclaration() {
        return declarationType == VariableType.INSTRUCTION_DECLARATION;
    }
