...
public class NestedSymbolTable {
    ...
    public Map<String, String> getPointsTo() {
        return pointsTo;
    }

    public List<String> getRenamedVariables(String s) {
        return possibleRenames.get(s);
    }

    public Map<String, ChemicalResolution> getTable() {
        return symbols;
    }
    ...
    public void MarkSymbolInvalid(String symbol) {
        parent.MarkMySymbolInvalid();
    }
    ...
    public Map<String, Integer> getUsagedTable() {
        return this.lastUsedIn;
    }
    ...
    public Integer getDefinitionID(String s) {
        return symbolDefinedIn.get(s);
    }

    public Map<String, Integer> getDefinitionTable() {
        return symbolDefinedIn;
    }
    ...
    public NestedSymbolTable getParent() {
        return parent;
    }

    public void setParent(NestedSymbolTable parent) {
        this.parent = parent;
    }
