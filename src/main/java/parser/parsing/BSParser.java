...
public class BSParser implements BSParserConstants {
    ...
    final public BSProgram BSProgram() throws ParseException {
        ...
        try {
            ...
            n0 = Stationary();
            n1 = Manifest();
            n3 = jj_consume_token(INSTRUCTIONS);
            ...
            {
                if ("" != null) return new BSProgram(n0, n1, n2, n4, n5);
            }
    ...
    final public Stationary Stationary() throws ParseException {
        ...
        try {
            ...
            n2 = Identifier();
            {
                if ("" != null) return new Stationary(n0, n2);
            }
            throw new Error("Missing return statement in function");
        } finally {
    ...
    final public Manifest Manifest() throws ParseException {
        ...
        try {
            ...
            n2 = Identifier();
            {
                if ("" != null) return new Manifest(n0, n2);
            }
            throw new Error("Missing return statement in function");
        } finally {
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[]{0x70037c0, 0x7003780, 0x7000000, 0x0, 0x0, 0x0, 0x440, 0x200, 0x1400, 0x7000000, 0x7000000, 0x1c000, 0x8000000, 0x8000000,};
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[]{0x400000, 0x400000, 0x0, 0x80000, 0x40000, 0x40000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x630000, 0x630000,};
    }
