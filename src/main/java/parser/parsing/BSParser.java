...
{if ("" != null) return new Manifest(n0,n2,n4);}
  ...
  final public Sequence Sequence() throws ParseException {NodeChoice n0;
...
{if ("" != null) return new FunctionDefinition(n0,n2,n3,n5,n7,n9,n14,n16,n18,n23);}
  ...
  final public Statement Statement() throws ParseException {NodeChoice n0;
   Assignment n1;
   BranchInstruction n2;
   RepeatInstruction n3;
   HeatInstruction n4;
   DrainInstruction n5;
   Expression n6;
    if (jj_2_1(3)) {
...
n0 = new NodeChoice(n1, 0);
      ...
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case IF:{
        n2 = BranchInstruction();
n0 = new NodeChoice(n2, 1);
        break;
        }
      case REPEAT:{
        n3 = RepeatInstruction();
...
{if ("" != null) return new FormalParameterRest(n0,n2);}
  ...
  final public BranchInstruction BranchInstruction() throws ParseException {IfStatement n0;
   NodeListOptional n1 = new NodeListOptional();
   ElseIfStatement n2;
...
{if ("" != null) return new BranchInstruction(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
...
n10 = JTBToolkit.makeNodeToken(n11);
{if ("" != null) return new IfStatement(n0,n2,n4,n5,n7,n9,n10);}
    throw new Error("Missing return statement in function");
  }

  final public ElseIfStatement ElseIfStatement() throws ParseException {NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   Expression n4;
...
n7 = JTBToolkit.makeNodeToken(n8);
    ...
    n11 = jj_consume_token(RBRACE);
n10 = JTBToolkit.makeNodeToken(n11);
{if ("" != null) return new ElseIfStatement(n0,n2,n4,n5,n7,n9,n10);}
    throw new Error("Missing return statement in function");
  }

  final public ElseStatement ElseStatement() throws ParseException {NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   Statement n4;
...
n5 = JTBToolkit.makeNodeToken(n6);
{if ("" != null) return new ElseStatement(n0,n2,n4,n5);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return new ExpressionList(n0,n1);}
  ...
  final public ExpressionRest ExpressionRest() throws ParseException {NodeToken n0;
   Token n1;
   Expression n2;
    n1 = jj_consume_token(COMMA);
n0 = JTBToolkit.makeNodeToken(n1);
...
{if ("" != null) return new ExpressionRest(n0,n2);}
  ...
  final public Assignment Assignment() throws ParseException {NodeOptional n0 = new NodeOptional();
   TypingList n1;
   Identifier n2;
   NodeToken n3;
   Token n4;
...
n3 = JTBToolkit.makeNodeToken(n4);
    n5 = Expression();
{if ("" != null) return new Assignment(n0,n2,n3,n5);}
    throw new Error("Missing return statement in function");
  }

  final public MixInstruction MixInstruction() throws ParseException {NodeToken n0;
   Token n1;
...
{if ("" != null) return new MixInstruction(n0,n2,n3,n5,n6);}
    throw new Error("Missing return statement in function");
  }

  final public SplitInstruction SplitInstruction() throws ParseException {NodeToken n0;
   Token n1;
   PrimaryExpression n2;
   NodeToken n3;
   Token n4;
...
n3 = JTBToolkit.makeNodeToken(n4);
    n5 = IntegerLiteral();
{if ("" != null) return new SplitInstruction(n0,n2,n3,n5);}
    throw new Error("Missing return statement in function");
  }

  final public DrainInstruction DrainInstruction() throws ParseException {NodeToken n0;
   Token n1;
   PrimaryExpression n2;
    n1 = jj_consume_token(DRAIN);
n0 = JTBToolkit.makeNodeToken(n1);
    n2 = PrimaryExpression();
{if ("" != null) return new DrainInstruction(n0,n2);}
    throw new Error("Missing return statement in function");
  }

  final public HeatInstruction HeatInstruction() throws ParseException {NodeToken n0;
   Token n1;
   PrimaryExpression n2;
   NodeToken n3;
   Token n4;
...
{if ("" != null) return new HeatInstruction(n0,n2,n3,n5,n6);}
    throw new Error("Missing return statement in function");
  }

  final public DetectInstruction DetectInstruction() throws ParseException {NodeToken n0;
   Token n1;
   PrimaryExpression n2;
   NodeToken n3;
   Token n4;
...
{if ("" != null) return new DetectInstruction(n0,n2,n3,n5,n6);}
    throw new Error("Missing return statement in function");
  }

  final public RepeatInstruction RepeatInstruction() throws ParseException {NodeToken n0;
   Token n1;
   IntegerLiteral n2;
   NodeToken n3;
   Token n4;
...
n8 = JTBToolkit.makeNodeToken(n9);
{if ("" != null) return new RepeatInstruction(n0,n2,n3,n5,n7,n8);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return new FunctionInvoke(n0,n1,n3,n5);}
  ...
  final public Expression Expression() throws ParseException {NodeChoice n0;
   ...
   FunctionInvoke n12;
   MixInstruction n13;
   SplitInstruction n14;
   DetectInstruction n15;
...
n0 = new NodeChoice(n13, 12);
      ...
      n14 = SplitInstruction();
n0 = new NodeChoice(n14, 13);
    } else if (jj_2_17(3)) {
      n15 = DetectInstruction();
  ...
  private boolean jj_3R_59()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x8000000,0x20000,0x40000,0x478073c0,0x7000000,0x7000000,0x478073c0,0x7000000,0x0,0x470073c0,0x20000000,0x400073c0,0x0,0x3000000,0x0,0x7000000,0x8000,0x10000,0x0,0x7000000,0x400,0x400,0x400,0x400010c0,0x40000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x3300000,0x0,0x0,0x3300000,0x2000000,0x800000,0x3300000,0x0,0x3300000,0x400000,0x0,0x400000,0x0,0x0,0x0,0x400000,0x0,0x0,0x0,0x0,0x3300000,0x3300000,};
   }
