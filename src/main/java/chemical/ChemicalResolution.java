...
public class ChemicalResolution implements Serializable {
    ...
    public void setIsStationary(Boolean isStationary) {
        __isStationary = isStationary;
    }

    public void addLiteral(Chemical chemical) {
        __chemicalLiterals.add(chemical);
    }
    ...
    public List<ChemicalResolution> getReferences() {
        return __chemicalReferences;
    }

    public List<Chemical> getLiterals() {
        return __chemicalLiterals;
    }
